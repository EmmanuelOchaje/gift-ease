...
const Hiw = () => {
  return (
    <div>
      <h2 className="cl m-8 font-semibold text-center">HOW IT WORKS</h2>
      <div className="flex-col md:flex-row lg:flex justify-between md:mx-14 my-14 ">
        <div className=" w-[264px] mb-10 m-auto lg:m-0">
          ...
          <h2 className="cl font-bold text-[15px] md:text-[20px] text-center">
            Create An Account
          </h2>
          <p className="cl text-center ">
        ...
        <div className=" w-[264px] mb-10 m-auto lg:m-0">
          ...
          <h2 className="cl font-bold md:text-[20px] text-center">
            Fund Your Wallet
          </h2>
          <p className="cl text-center ">
        ...
        <div className=" w-[264px] mb-10 m-auto lg:m-0">
          ...
          <h2 className="cl md:text-[20px] font-bold text-center">
            Generate Voucher
          </h2>
          <p className="cl text-center ">
